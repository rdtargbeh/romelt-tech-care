...
/**
 * ================================================================
 * ROMELT TECHCARE — PRICING PLAN VERSION CREATE REQUEST
 * ================================================================
 *
 * Purpose:
 * Carries administrator input for creating a draft pricing-plan
 * version.
 *
 * Version ownership:
 * The pricing-plan identifier is supplied through the endpoint path.
 *
 * Version numbering:
 * The backend calculates the next version number.
 * ================================================================
 */
public record WebsitePricingPlanVersionCreateRequest(
