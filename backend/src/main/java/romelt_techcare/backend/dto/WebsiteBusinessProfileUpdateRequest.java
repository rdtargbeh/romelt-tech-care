...
/**
 * ================================================================
 * ROMELT TECHCARE — WEBSITE BUSINESS PROFILE UPDATE REQUEST
 * ================================================================
 *
 * Purpose:
 * Carries the complete editable state of the public business profile.
 *
 * Update model:
 * This is a full replacement request for editable profile fields.
 * Use PUT rather than PATCH for this DTO.
 * ================================================================
 */
public record WebsiteBusinessProfileUpdateRequest(
        ...
        @NotNull(message = "Appointment-only status is required.")
